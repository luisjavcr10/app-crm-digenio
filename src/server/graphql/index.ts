...
export const typeDefs = mergeTypeDefs([authTypeDefs, userTypeDefs, okrsTypeDefs, startupsTypeDefs]);
export const resolvers = mergeResolvers([authResolvers, userResolvers, okrsResolvers, startupResolvers]);